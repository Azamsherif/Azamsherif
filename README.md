...
- **المسمى الوظيفي:** مطور .NET Full-Stack مبتدئ
- **الموقع:** القوصية، أسيوط، مصر
- **التعليم:** مسار DEPI لتطوير .NET Full-Stack

أنا مطور .NET Full-Stack مبتدئ، ولدي أساس قوي في بناء تطبيقات ويب حديثة وواجهات برمجية
REST وأنظمة تعتمد على قواعد البيانات. أستمتع بتحويل الأفكار إلى حلول عملية قابلة للتطوير
باستخدام كود نظيف ومعمارية سهلة الصيانة.

- 🚀 أركّز على تطوير الـ Backend باستخدام **ASP.NET Core**
- 🧠 مهتم جداً بـ **Clean Code** و**SOLID** والتصميم القابل للتوسع
...
### 🎓 نظام إدارة التعلّم
منصة تعليم إلكتروني متكاملة تم تطويرها باستخدام **ASP.NET Core MVC** لإدارة الكورسات والمدربين والتسجيل ومتابعة تقدّم الطلاب.

**أبرز النقاط**
- لوحة تحكم للإدارة مع صلاحيات مختلفة
- إدارة الكورسات والمحتوى
- متابعة تقدّم الطلاب
- معمارية MVC نظيفة
- EF Core + LINQ + SQL Server
- واجهة متجاوبة باستخدام Razor Views وBootstrap وJavaScript

---

### 🖨 مطبعة المدينة
تطبيق ويب متكامل للأعمال تم تطويره باستخدام **React.js** و**Node.js** و**MongoDB**.

**المميزات**
- عرض المنتجات والمعرض
- لوحة تحكم للإدارة مع عمليات CRUD
- رفع الصور وإدارتها
- نموذج تواصل واستقبال الرسائل
- واجهة سلسة ومتجاوبة
- تواصل عبر RESTful API

---

### 🗃 تصميم قواعد البيانات والبنية المعمارية
عمل يركز على تصميم قاعدة بيانات قابلة للتطوير لنظام يشبه منصات العمل الحر.

**أبرز النقاط**
- تصميم ERD
- تصميم مخطط علائقي
- التطبيع (1NF, 2NF, 3NF)
- تنفيذ باستخدام SQL Server
- استعلامات T-SQL وإجراءات مخزنة
- الحفاظ على تكامل البيانات وتحسين الأداء
...
- **مبادرة رواد مصر الرقمية (DEPI)** — تطوير .NET Full-Stack
- **الجامعة العربية المفتوحة (AOU)** — بكالوريوس علوم الحاسب
- **Introduction to Databases** — ITI
- **Python Programming Basics** — Udacity
- **ICDL** — Edraak
